...
export const metadata = { title: "Propiedades en Venta — BS Mérida" };
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-8 py-12">
        <div className="mb-8">
          <h1 className="text-3xl font-semibold text-ink tracking-tight">Propiedades en venta</h1>
          <p className="text-sm text-ink-muted mt-1">Encuentra la propiedad ideal en Yucatán, Quintana Roo y Nuevo León</p>
        </div>
